...
switch(DB_URL){
	case 'localhost':
		...
		defined ("SITE_URL") or define("SITE_URL", 'http://localhost/mlo');
		defined ("HOME_URL") or define("HOME_URL", 'http://localhost/mlo/dashboard');
	break;

	case 'https://mlowawatoto.org': 
		defined ("DB_SERVER") or define("DB_SERVER", "localhost");
		defined ("DB_USER") or define("DB_USER", "mlowawatoto_userx");
		defined ("DB_PASS") or define("DB_PASS", "kFq+q0B[4L^3");
		defined ("DB_NAME") or define("DB_NAME", "mlowawatoto_dbx");
		defined ("SITE_URL") or define("SITE_URL", "https://mlowawatoto.org");
		defined ("HOME_URL") or define("HOME_URL", "https://mlowawatoto.org");
	break;
...
function getTimeBasedGreeting($fullname) {  
  ...
  return $greeting . ", " . ucwords($fullname);  
}  
