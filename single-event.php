...
<!-- Mirrored from st.ourhtmldemo.com/new/humanity-html/single-event.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Feb 2026 09:30:19 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-md-9 menu-column">
                <nav class="defaultmainmenu" id="main_menu">
                   <ul class="defaultmainmenu-menu">
                        ...
                        <ul class="dropdown">
                            <li><a href="about.html">About humanity</a></li>
                        ...
                        <ul class="dropdown">
                            <li><a href="cause-1.html">Causes Grid View</a></li>
                            <li><a href="cause-2.html">Causes List View</a></li>
                            <li><a href="cause-3.html">Causes With Sidebar</a></li>
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a href="gallery-2.html">gallery Fullwidth</a></li>
                            <li><a href="gallery-3.html">gallery With Text</a></li>
                        ...
                        <li><a href="#">mega menu</a>
                            ...
                            <div class="megamenu clearfix megamenu-width-100">
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="post-list">
                                        <div class="post">
                                            <div class="post-thumb"><a href="blog-details.html"><img src="images/resource/thumb2.jpg" alt=""></a></div>
                                            <a href="blog-details.html"><h5>New Award To Support <br>Children Affected by Crises </h5></a>
                                            <div class="post-info">October 21, 2016</div>
                                        </div>
                                        <div class="post">
                                            <div class="post-thumb"><a href="blog-details.html"><img src="images/resource/thumb3.jpg" alt=""></a></div>
                                            <a href="blog-details.html"><h5>Help promote girl's Education <br>in the world</h5></a>
                                            <div class="post-info">January 14, 2016</div>
                                        </div>
                                        <div class="post">
                                            <div class="post-thumb"><a href="blog-details.html"><img src="images/resource/thumb4.jpg" alt=""></a></div>
                                            <a href="blog-details.html"><h5>Clean poor urban areas to <br>protect from pollution.</h5></a>
                ...
                <div class="single-event">
                    <div class="img-box">
                        ...
                        <div class="countdown-timer">
                            ...
                            <div class="link"><a href="#" class="thm-btn style-2">Book Now</a></div>          
                        </div>
                    </div>
                    <div class="content">
                            
                        <div class="text">
                            <p>Interested in participating the event 2017-18 California marathon pleasure & praising pain was born and will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth the master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is those who do not know how to pursue pleasure rationally encounter.</p>
                        </div><br><br>
                        ...
                        <div class="event-schedule">
                            ...
                            <div class="text"><p>
                                Explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you account of the system, and expound the actual teachings of the great explorer.</p>
                            </div>
                            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="event-timeline">
                                ...
                                <ul>
                                    <li><i class="fa fa-calendar"></i><b>Event Startd On: </b> Tuesday April <br>14, 2017 11.00am</li>
                    ...
                    <div class="default-form-area">
                        <form id="contact-form" name="contact_form" class="default-form" action="https://st.ourhtmldemo.com/new/humanity-html/inc/sendmail.php" method="post" novalidate="novalidate">
                                ...
                                <div class="tabs-content">
                                    ...
                                    <div class="tab active-tab" id="tab-two" style="display: block;">
                                        <div class="default-form-area all">
                                            <form id="contact-form" name="contact_form" class="default-form style-5" action="https://st.ourhtmldemo.com/new/humanity-html/inc/sendmail.php" method="post">
                                                <div class="clearfix">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="footer-widget about-column">
                                ...
                                <div class="text"><p>We partner with over 320 amazing projects worldwide, and have given over $150 million in cash and product grants to other groups since 2011. We also operate our own dynamic suite of Signature Programs, million in cash and product grants to others</p> </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="footer-widget link-column">
                                ...
                                <div class="widget-content">
                                    <ul class="list">
                                        <li><a href="about.html">About Our Humanity</a></li>
                                        <li><a href="cause-1.html">Recent Causes</a></li>
                                        <li><a href="volunteer.html">Our Volunteers</a></li>
                                        <li><a href="#">Our Donators</a></li>
                                        <li><a href="#">Sponsers</a></li>
                                        <li><a href="event-1.html">Upcoming Events</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="footer-widget post-column">
                                ...
                                <div class="post-list">
                                    ...
                                    <div class="post">
                                        <a href="#"><h5>humanity Bikini Car wash photos</h5></a>
...
<!-- Mirrored from st.ourhtmldemo.com/new/humanity-html/single-event.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Feb 2026 09:30:21 GMT -->
</html>