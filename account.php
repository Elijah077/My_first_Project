...
<!-- Mirrored from st.ourhtmldemo.com/new/humanity-html/account.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Feb 2026 09:31:42 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="row">
                    ...
                    <div class="form-column column col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="styled-form login-form">
                            <form action="https://st.ourhtmldemo.com/new/humanity-html/index.html" method="post">
                                <div class="form-group">
                                    <span class="adon-icon"><span class="fa fa-user"></span></span> <input name="username" placeholder="Your Name *" type="text" value="">
                                </div>


                                <div class="form-group">
                                    <span class="adon-icon"><span class="fa fa-envelope-o"></span></span> <input name="useremil" placeholder="Enter Mail id *" type="email" value="">
                                </div>


                                <div class="form-group">
                                    <span class="adon-icon"><span class="fa fa-unlock-alt"></span></span> <input name="userpassword" placeholder="Enter Password" type="password" value="">
                                </div>


                                <div class="clearfix">
                                    <div class="form-group pull-left">
                                        <button class="thm-btn thm-tran-bg" type="button">login now</button>
                                    </div>


                                    <div class="form-group social-links-two padd-top-5 pull-right">
                                        Or login with <a class="img-circle facebook" href="#"><span class="fa fa-facebook-f"></span></a> <a class="img-circle twitter" href="#"><span class="fa fa-twitter"></span></a> <a class="img-circle google-plus" href="#"><span class="fa fa-google-plus"></span></a>
                                    </div>
                                </div>
                    ...
                    <div class="form-column column col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="styled-form register-form">
                            <form action="https://st.ourhtmldemo.com/new/humanity-html/index.html" method="post">
                                ...
                                <div class="clearfix">
                                    <div class="form-group pull-left">
                                        <button class="thm-btn thm-tran-bg" type="button">Register here</button>
                                    </div>
